...
import { sessionOverviewDays, sessionOverviewTotalValue } from './sessionOverviewData'
...
const COLUMNS = [
  ...
  { label: 'Session', align: 'left', width: '25%' },
...
export function SessionOverview({ selectedDate }: SessionOverviewProps) {
                  ...
                  day.rows.map((row, index) => (
                    ...
                    >
                      {index === 0 && (
                        <td
                          className={cellClass}
                          style={{ borderColor: tokens.colorBorderWeak }}
